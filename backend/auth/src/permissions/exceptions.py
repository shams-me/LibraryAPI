...
class PermissionUserBlocked(PermissionAPIError):
    status_code = HTTPStatus.FORBIDDEN
...
class PermissionNameExistsError(PermissionAPIError):
    ...
    detail = "Permission with this src and type already exists"
...
class PermissionInternalDoesNotExistError(PermissionAPIError):
    ...
    detail = "Permission required to perform this operation does not exist in the database"
