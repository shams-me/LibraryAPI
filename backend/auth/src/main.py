...
from src.role.api.v1 import router as roles_router
...
app.include_router(auth_router.router, prefix="/auth/api/v1/auth", tags=["Auth"])
app.include_router(users_router.router, prefix="/auth/api/v1/users", tags=["Users"])
app.include_router(roles_router.router, prefix="/auth/api/v1/roles", tags=["Roles"])
app.include_router(permissions_router.router, prefix="/auth/api/v1/permissions", tags=["Permissions"])
